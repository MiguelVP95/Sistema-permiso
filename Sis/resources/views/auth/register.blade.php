                    ...
                    <form method="POST" action="{{ route('register') }}">
                       ...
                       <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="sede" type="text" class="form-control @error('sede') is-invalid @enderror" name="sede" value="{{ old('sede') }}" required autocomplete="sede">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="dependencia" type="text" class="form-control @error('dependencia') is-invalid @enderror" name="dependencia" value="{{ old('dependencia') }}" required autocomplete="dependencia">
